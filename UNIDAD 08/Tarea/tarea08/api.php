...
/**
 * Busca libros cuyo título contenga un texto
 *
 * @param string $texto Texto introducido por el usuario
 * @return array|null Lista de libros encontrados
 */
function buscar_libros($texto) {
    global $librosBD, $con;

    try {
        $sql = "SELECT id, titulo FROM Libro WHERE titulo LIKE ?";
